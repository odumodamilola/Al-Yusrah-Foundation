...
<head>
    ...
    <title>Al Yusrah Foundation</title>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofN5P5iK3eDhIbb5Vz1ZRMd5S+JZbDI1O" crossorigin="anonymous">
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="/">
                    <span class="align-middle">Al Yusrah Foundation</span>
                </a>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('admin.viewmembers') }}">
                            <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">View
                                Members</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('admin.registermembers') }}">
                            <i class="align-middle" data-feather="book"></i> <span class="align-middle">Register
                                Members</span>
                        </a>
                    </li>
                    ...
                    <ul class="navbar-nav navbar-align">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('static/img/avatars/avatar-5.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('static/img/avatars/avatar-2.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('static/img/avatars/avatar-4.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('static/img/avatars/avatar-3.jpg') }}"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img style="height: 42px" id="profileImage"
                                    src="{{ asset('storage/' . auth()->user()->profile_image) }}"
                                    alt="user image"class="avatar img-fluid rounded me-1" alt="Charles Hall">

                                {{-- <img src="{{ asset('static/img/avatars/avatar.jpg') }}"
                                     class="avatar img-fluid rounded me-1" alt="Charles Hall" /> --}} <span
                                    class="text-dark">{{ Auth::user()->firstname . ' ' . Auth::user()->lastname }}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button class="ms-2" type="submit"
                                        style="background-color: #dc3545;font-size:15px; color: #fff; padding: 6px 12px; border: 1px solid #dc3545; border-radius: 4px;">
                                        Logout
                                    </button>
                                </form>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Al
                                        Yusrah Foundation 2024</strong></a> &copy;
                            </p>
                        </div>
